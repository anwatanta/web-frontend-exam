...
<template>
  <div v-if="jobId" class="fixed inset-0 z-50 flex items-center justify-center px-[22px]">
    ...
    <!-- Modal card -->
    <div
      class="max-h-3xl relative z-10 flex h-[70vh] w-full max-w-[750px] flex-col rounded-sm bg-white shadow-[0_9px_46px_8px_rgba(0,0,0,0.12),0_24px_38px_3px_rgba(0,0,0,0.14),0_11px_15px_-7px_rgba(0,0,0,0.2)]"
    >
      <template v-if="job">
        <h2
